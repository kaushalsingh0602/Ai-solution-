  ...
  return( 
    <section className="py-20 md:py-20">
     <div className=" container">
      <h2  className=" text-5xl md:text-6xl text-center trecking-tighter font-medium">Beyond Expectations.</h2>
            ...
            <div className="flex  items-center gap-3 mt-5">
              <div className=" relative after:content-[''] after:absolute after:inset-0 after:bg-[rgb(140,69,244)] after:mix-blend-soft-light before:content-[''] before:absolute before:inset-0 before:border before:border-white/30 before::z-10 before::rounded-lg">
                <Image src={testimonial.avatarImg} 
                  alt={`Avater for ${testimonial.name}`} 
                  className="h-11 w-11 rounded-lg grayscale border-white/30"
                />
              </div>
            <div className=" ">
            <div>{testimonial.name}</div>
            <div className=" text-white/15 text-sm">{testimonial.title}</div> 
